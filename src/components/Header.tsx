  ...
  return (
    <>
      ...
      <header className="bg-white shadow-[0_4px_20px_rgba(38,38,38,0.1)] fixed top-0 w-full z-50">
        <nav className="container-padding flex items-center justify-between h-16">
          {/* Mobile menu button */}
          ...
          <div className="flex-1 flex justify-center md:justify-start">
            <Link to="/" className="font-bold text-xxl md:text-lg text-gray-800">
              WorkSafety<span className="w-1 h-1 bg-orange-400 inline-block" />
            </Link>
          </div>
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex flex-col h-full p-6 space-y-6">
            ...
            >
              WorkSafety<span className="w-1 h-1 bg-orange-400 inline-block"></span>
            </Link>
