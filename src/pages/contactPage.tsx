...
const ContactPage = () => {
  ...
  return (
    <div className="container-padding section-space px-4 sm:px-6 lg:px-8 py-12">
      {loading ? <div className="flex items-center h-[500px] justify-center bg-white bg-opacity-75 group">
        <NoResults
              ...
              <div className="text-left">
                ...
                <form className="space-y-6">
                  {[
                    ...
                    { name: "address1", placeholder: "Address 1", icon: <MapPin /> },
                    { name: "address2", placeholder: "Address 2 (Optional)", icon: <MapPin /> },
                    { name: "city", placeholder: "City", icon: <Building /> },
                    { name: "postcode", placeholder: "Postcode", icon: <Code /> },
                    { name: "company", placeholder: "Company Name", icon: <UserCheck /> },
                    ...
                    <div key={name} className="space-y-1">
                      ...
                      <div
                        className="relative border-b border-gray-300 focus-within:border-pink-500 transition-colors"
                      >
                        <input
                          id={name}
                          type="text"
