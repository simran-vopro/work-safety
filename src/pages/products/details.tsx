            ...
            <div className="container-padding section-space grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div>
                    <h1 className="text-2xl font-semibold">
                        {product?.Style ? `${product.Style} - ` : ""}{product?.Description}
                    </h1>
                    ...
                    <div className="flex border-b mb-4">
                        <button
                            ...
                            className={`px-4 py-2 font-medium ${activeTab === "description" ? "border-b-2 border-orange-500 text-orange-500" : ""
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 font-medium ${activeTab === "technical" ? "border-b-2 border-orange-500 text-orange-500" : ""
                                }`}
                        >
                            Technical Info
                        </button>
                    ...
                    {activeTab === "technical" && (
                        <div className="app-text-normal">
                            ...
                            <p><strong>Manufacturer Code:</strong> {product?.ManufacturerCode}</p>
                            <p><strong>RRP:</strong> £{product?.rrp?.toFixed(2)}</p>
                            <p><strong>Pack Size:</strong> {product?.Pack}</p>
                            <p><strong>Category:</strong> {product?.Category1?.Category1} / {product?.Category2?.Category2}</p>
                        </div>
                    )}
