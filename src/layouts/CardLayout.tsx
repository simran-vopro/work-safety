                            ...
                            >
                                ...
                                <div className="flex-1 flex items-center justify-center overflow-hidden">
                                    <img
                                        ...
                                        src={item.image}
                                        alt={item.Category1}
                                        className="w-30 h-30 object-cover rounded-full transition-transform duration-300 mr-4"
                        ...
                        {extraCards.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="w-full py-4 text-center">
                                        <p className="font-semibold group-hover:text-pink-500 uppercase tracking-wide">{item.Category1}</p>
                                    </div>
                                </div>
                            );
                        })}
